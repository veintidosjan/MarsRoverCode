#modifications line 243 and 286 added 90 degrees for direction compensation charles
#
#
#!/usr/bin/python
#
...
#def currentAngle():
    ...
    #print(round(tiltCompensatedHeading))
    #return int(round(tiltCompensatedHeading))
...
def compass():
    ...
    while True:
       ...
       #Convert Accelerometer values to degrees
        ...
        #Calculate heading
        heading = 180 * math.atan2(MAGy,MAGx)/M_PI #added 90 degrees for position compensation (Charles)
        ...
        tiltCompensatedHeading = 180 * math.atan2(magYcomp,magXcomp)/M_PI + 74 #added 90 degrees for position compensation (Charles)
        ...
        #print(outputString)
        print(round(tiltCompensatedHeading))
        return round(tiltCompensatedHeading)
